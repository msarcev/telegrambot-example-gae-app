 ...
 *
 */
package org.telebot.nixtabyte.jtelebot.requestfactory;
...
import org.telebot.nixtabyte.jtelebot.mapper.json.MapperHandler;
import org.telebot.nixtabyte.jtelebot.response.json.CustomReplyKeyboard;
import org.telebot.request.BroadcastActionType;
import org.telebot.request.RequestType;
...
public final class TelegramRequestFactory {
	 ...
	 *
	 * @param chatId Unique identifier for the message recipient ďż˝ďż˝ďż˝ User or GroupChat id
	 ...
	 *
	 * @param chatId Unique identifier for the message recipient ďż˝ďż˝ďż˝ User or GroupChat id
	 * @param fromChatId Unique identifier for the chat where the original message was sent ďż˝ďż˝ďż˝ User or GroupChat id
	 ...
	 * @param limit Limits the number of photos to be retrieved. Values between 1ďż˝ďż˝ďż˝100 are accepted. Defaults to 100.
	 ...
	 * @param limit Optional - Limits the number of updates to be retrieved. Values between 1ďż˝ďż˝ďż˝100 are accepted. Defaults to 100
